...
UDPServer::UDPServer(int domain, int service, int protocol, int port, uint32_t interface) {
...
void UDPServer::stop_udp_listener() {
    running = false;
...
BindingSocket* UDPServer::get_udp_socket() const {
    return udp_socket;
}
