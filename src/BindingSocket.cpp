...
BindingSocket::BindingSocket(int domain, int service, int protocol, int port, uint32_t interface)
...
int BindingSocket::bind2self(int sock, const struct sockaddr_in &address) {
