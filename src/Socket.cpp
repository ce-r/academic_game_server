...
Socket::Socket(int domain, int service, int protocol, int port, uint32_t interface) : socket_type(service) {    
...
void Socket::test_sock(int test_socket) {
...
void Socket::set_address(const struct sockaddr_in &addr) {
